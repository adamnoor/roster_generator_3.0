...
exclude_players_label.grid(row=0, column=2)
exclude_players_entry.grid(row=1, column=2)
max_budget_label.grid(row=2, column=1)
budget_max_entry.grid(row=3, column=1)
min_budget_label.grid(row=4, column=1)
budget_min_entry.grid(row=5, column=1)
max_projection_label.grid(row=2, column=2)
projection_max_entry.grid(row=3, column=2)
min_projection_label.grid(row=4, column=2)
projection_min_entry.grid(row=5, column=2)


output_line2_label.grid(row=6, column=1)
output_line3_label.grid(row=7, column=1)
output_line4_label.grid(row=8, column=1)
